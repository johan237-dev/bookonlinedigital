...
class Livres1reC extends StatelessWidget {
  Livres1reC({super.key});
  final CollectionReference lIvres1ereC = FirebaseFirestore.instance.collection("LIvres1ereC");
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: AppBar(
          title: const Text("Livres de la classe de 1ereC",
            style: TextStyle(
              fontSize: 24,
        ...
        body: Padding(
          ...
          child:StreamBuilder(
              stream: FirebaseFirestore.instance.collection("LIvres1ereC").snapshots(),
