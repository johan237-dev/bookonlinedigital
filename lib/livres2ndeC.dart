...
class Livres2ndeC extends StatelessWidget {
  ...
  final CollectionReference livres2ndeC = FirebaseFirestore.instance.collection("Livres2ndeC");

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: AppBar(
          title: const Text("Livres de la classe de 2ndeC",
            style: TextStyle(
                fontSize: 24,
        ...
        body: Padding(
          ...
          child:StreamBuilder(
              stream: FirebaseFirestore.instance.collection("Livres2ndeC").snapshots(),
