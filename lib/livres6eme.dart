...
class Livres6eme extends StatelessWidget {
   Livres6eme({super.key});
  final CollectionReference livres6eme = FirebaseFirestore.instance.collection("Livres6eme");

  @override
  Widget build(BuildContext context) {
  return Scaffold(
    appBar: AppBar(
      title: const Text("Livres de la classe de 6eme",
        style: TextStyle(
            fontSize: 24,
    ...
    body: Padding(
      ...
      child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("Livres6eme").snapshots(),
