...
class LivresTleD extends StatelessWidget {
  LivresTleD({super.key});
  final CollectionReference livresTleD = FirebaseFirestore.instance.collection("LivresTleD");

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: AppBar(
          title: const Text("Livres de la classe de TleD",
            style: TextStyle(
                fontSize: 24,
        ...
        body: Padding(
          ...
          child:StreamBuilder(
              stream: FirebaseFirestore.instance.collection("LivresTleD").snapshots(),
