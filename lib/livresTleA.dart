...
class LivresTleA extends StatelessWidget {
  LivresTleA({super.key});
  final CollectionReference livresTleA = FirebaseFirestore.instance.collection("LivresTleA");

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: AppBar(
          title: const Text("Livres de la classe de TleA4",
            style: TextStyle(
                fontSize: 24,
        ...
        body: Padding(
          ...
          child:StreamBuilder(
              stream: FirebaseFirestore.instance.collection("LivresTleA").snapshots(),
