...
class Livres4eme extends StatelessWidget {
  Livres4eme({super.key});
  final CollectionReference livres4eme = FirebaseFirestore.instance.collection("Livres4eme");

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: AppBar(
          title: const Text("Livres de la classe de 4eme",
            style: TextStyle(
                fontSize: 24,
        ...
        body: Padding(
          ...
          child:StreamBuilder(
              stream: FirebaseFirestore.instance.collection("Livres4eme").snapshots(),
