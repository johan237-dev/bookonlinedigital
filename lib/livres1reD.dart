...
class Livres1reD extends StatelessWidget {
  Livres1reD({super.key});
  final CollectionReference livres1ereD = FirebaseFirestore.instance.collection("Livres1ereD");

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: AppBar(
          title: const Text("Livres de la classe de 1ereD",
            style: TextStyle(
                fontSize: 24,
        ...
        body: Padding(
          ...
          child:StreamBuilder(
              stream: FirebaseFirestore.instance.collection("Livres1ereD").snapshots(),
