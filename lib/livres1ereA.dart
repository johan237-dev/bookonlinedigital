...
class Livres1reA extends StatelessWidget {
  Livres1reA({super.key});
  final CollectionReference livres1reA = FirebaseFirestore.instance.collection("Livres1reA");

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: AppBar(
          title: const Text("Livres de la classe de 1reA4",
          style: TextStyle(
            fontSize: 24,
        ...
        body: Padding(
          ...
          child:StreamBuilder(
              stream: FirebaseFirestore.instance.collection("Livres1reA").snapshots(),
